...
public class NavigatorAgent extends Agent {
    ...
    private class LocationRequestsServer extends CyclicBehaviour {
        ...
        private String getAdvice(String content) {
            ...
            switch (rand) {
                case 1:
                    return WumpusWorldAgent.Constants.ACTION_PROPOSAL1 + advicedAction;
                case 2:
                    return WumpusWorldAgent.Constants.ACTION_PROPOSAL2 + advicedAction;
                case 3:
                    return WumpusWorldAgent.Constants.ACTION_PROPOSAL3 + advicedAction;
                default:
                    return "";
            }
        }
